                ...
                <table cellspacing="0" class="form-list">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="value"><?php echo $form->dropDownList($model,'product_new_arrivals',array(0=>'不标记' ,1=>'标记'),array('id'=>'product_new_arrivals'));?></td>
            ...
            <div class="hor-scroll">
                <table cellspacing="0" class="form-list">
                    <tbody>
                        ...
                        <tr>
                            <td class="label">
                                <label for=""><?php echo $value['attribute'];?><span class="required">*</span></label>
                            </td>
        ...
        <div id="group_3fieldset_group_3" class="fieldset fieldset-wide">
            <div class="hor-scroll" id="inventory_form">
                <table cellspacing="0" class="form-list">
                    <tbody>
                        <tr>
                            <td class="label"><label for="product_stock_qty">库存量<span class="required">*</span></label></td>
                        ...
                        <?php $stockConfig=Config::items('stock');?>
                        <tr>
                            <td class="label"><label for="product_stock_cart_min">购物车最小件数</label></td>
                            <td class="value"><?php echo $form->textField($model,'product_stock_cart_min',array('class'=>'input-text','id'=>'product_stock_cart_min','value'=>$stockConfig['stock_cart_min']));?></td>
                        ...
                        <tr>
                            ...
                            <td class="value"><?php echo $form->textField($model,'product_stock_cart_max',array('class'=>'input-text','id'=>'product_stock_cart_max','value'=>$stockConfig['stock_cart_max']));?>(-1表示无限制)</td>
