        ...
        <div id="group_3fieldset_group_3" class="fieldset fieldset-wide">
            <div class="hor-scroll" id="promotion_form">
                <table cellspacing="0" class="form-list">
                    <tbody>
                        <tr>
                            <td class="label"><label for="">产品名称</label></td>
                            <td class="value"><?php echo CHtml::link($product->product_name, '/backend/product/update/id/'.$product->product_id);?></td>
                            <td class="scope-label"></td>
                            <td><small>&nbsp;</small></td>
                        </tr>

                        <tr>
                            <td class="label"><label for="">商品价格</label></td>
                            <td class="value">定价:$<?php echo $product->product_base_price;?>&nbsp;&nbsp;&nbsp;&nbsp;原价:$<?php echo $product->product_orig_price;?>&nbsp;&nbsp;&nbsp;&nbsp;现价:$<?php echo $product->product_special_price;?></td>
                            <td class="scope-label"></td>
                            <td><small>&nbsp;</small></td>
                        </tr>
