...
<html>
    ...
    <body>
        <table style="font-family:Verdana,sans-serif; font-size:11px; color:#374953; width: 550px;">
            ...
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td align="left" style="background-color:#DB3484; color:#FFF; font-size: 12px; font-weight:bold; padding: 0.5em 1em;">Your order <?php echo $order_name ?> history</td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td align="left">
                    <b>There is a problem with your payment for order <?php echo $order_name ?>. Please contact us at your earliest convenience.</b>
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
